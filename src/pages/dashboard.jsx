...
function Dashboard() {
  ...
  return (
    <div className="dashboard">
      ...
      <div className="main-task-input">
        <input
          type="text"
          placeholder="What needs to be done?"
          value={newTask.title}
          onChange={(e) => setNewTask({...newTask, title: e.target.value})}
          className="big-task-input"
        />
        <div className="task-form">
          ...
          <div className="form-section options-row">
            <input
              type="date"
            ...
            <button onClick={addTask} className="save-button">Save Task</button>
          </div>
        </div>
      </div>
